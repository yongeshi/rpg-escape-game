...
public class Character {
    ...
    public String standingImage = "FinalProject/Down2.png";;
	...
	public Character(Pane root, Stage stage, Scene scene, LinkedList<ObstacleTile> barrier, ImageView dialog, Text dialogText, ImageView key, ImageView character_image) {
		...
		walkingUpImageList.add(new Image("FinalProject/Up1.png"));
		walkingUpImageList.add(new Image("FinalProject/Up2.png"));
		walkingUpImageList.add(new Image("FinalProject/Up3.png"));
		
		walkingDownImageList = new ArrayList<Image>();
		walkingDownImageList.add(new Image("FinalProject/Down1.png"));
		walkingDownImageList.add(new Image("FinalProject/Down2.png"));
		walkingDownImageList.add(new Image("FinalProject/Down3.png"));
		
		walkingRightImageList = new ArrayList<Image>();
		walkingRightImageList.add(new Image("FinalProject/Right1.png"));
		walkingRightImageList.add(new Image("FinalProject/Right2.png"));
		walkingRightImageList.add(new Image("FinalProject/Right3.png"));
		
		walkingLeftImageList = new ArrayList<Image>();
		walkingLeftImageList.add(new Image("FinalProject/Left1.png"));
		walkingLeftImageList.add(new Image("FinalProject/Left2.png"));
		walkingLeftImageList.add(new Image("FinalProject/Left3.png"));
    ...
    private void moveCharacter(int dx, int dy) {
        if (dx != 0 || dy != 0) {  // Only move if character has "speed" - added/subtracted from the key presses
	        ...
	        if (foundKey && x >= 137 && x <= 257 && y >= 757 && y <= 778) {
	    		...
	    		Image backgroundImage = new Image("FinalProject/start_background.png");
	    		...
	    		// Title
	    		ImageView title = new ImageView(new Image("FinalProject/You-Won.png"));
